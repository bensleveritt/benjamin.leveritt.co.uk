# Design Philosophy: Swiss Functional Design

## Core Principles

**"Good design is invisible"** - The best typography and layout should serve the content so well that you notice the message, not the medium.

**Form follows function, with mathematical precision and human empathy** - Not cold minimalism, but empathetic design that respects the reader's cognitive load.

**Objectivity over personality** - Neutral, factual communication that transcends personal ego and serves understanding.
...
- Half-formed thoughts are okay if they're honest

## For This Digital Garden

**Function**: Helping ideas connect and grow naturally
**Form**: Clean typography that doesn't compete with thoughts  
**Grid**: Consistent structure that lets content breathe
**Hierarchy**: Clear relationships between ideas
...
- Personal branding over content clarity

## Technical Implementation

- SvelteKit for minimal, fast code that serves content
- Asciidoc for structured, semantic content
- Typography choices based on function (Libre Franklin/Charter)
- Performance as respect for people's time
- Grid systems that organize thoughts, not just pixels
